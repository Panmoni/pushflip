...
and [docs/ZK_RESEARCH.md](ZK_RESEARCH.md) is the long-form write-up of
...
[docs/PINOCCHIO_RESOURCE_GUIDE.md](PINOCCHIO_RESOURCE_GUIDE.md) is the
...
[docs/POSEIDON_STACK_WARNING.md](POSEIDON_STACK_WARNING.md), and §11 of
[PINOCCHIO_RESOURCE_GUIDE.md](PINOCCHIO_RESOURCE_GUIDE.md#11-poseidon-hashing-via-sol_poseidon-syscall)
...
discovery is in
[docs/PINOCCHIO_RESOURCE_GUIDE.md §6](PINOCCHIO_RESOURCE_GUIDE.md):
...
3. **A dedicated guide section.** The empirical finding is recorded in
   [PINOCCHIO_RESOURCE_GUIDE.md §6](PINOCCHIO_RESOURCE_GUIDE.md) with
