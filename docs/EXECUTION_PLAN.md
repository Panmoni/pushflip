...
## Current Status (snapshot for new collaborators) — 2026-04-15 (Phase 3 complete; 5.0.4 + 5.0.5 + 5.0.8 + 5.0.9 PR 1 DONE; reviews #14 + #15 + #16 clean)
