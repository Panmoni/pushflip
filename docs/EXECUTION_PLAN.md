...
## Current Status (snapshot for new collaborators) — 2026-04-12 (Phase 3 fully complete through 3.7.4; 13th heavy-duty review clean)
...
##### 5.0.8: Biome lint rule for `useWallet().publicKey` in dependency arrays
